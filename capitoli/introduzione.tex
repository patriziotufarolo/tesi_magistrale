...
\begin{itemize}
    ...
    \item \textbf{Capitolo 5 - Validazione del framework.}\\
        ...
        Come illustrato nel capitolo 2, Moon Cloud è organizzato in microservizi gestiti tramite \textit{container}; in particolare, il deployment è effettuato su una IaaS OpenStack e una PaaS Docker.
        L'analisi si articola perciò in due fasi:
        \begin{enumerate}
            \item analisi dell'infrastruttura OpenStack sottostante, mediante OpenSCAP e controlli di sicurezza specifici mappati sui requisiti FedRAMP;
            \item \textit{assessment} dei container dei vari componenti di Moon Cloud e dei canali di comunicazione.
        \end{enumerate}
