...
\caption{Processo di autorizzazione, da \cite{} }\label{fig:fedrampactors}
\end{figure}


Nel modulo di richiesta di ammissione al programma il provider fornisce informazioni sul proprio sistema, categorizzandolo sulla base delle direttive contenute nel documento NIST SP 800-60 V2, e decide la \textit{baseline} dei controlli di sicurezza da implementare in base alla sensibilità del sistema (bassa o media).
...
\caption{Attori coinvolti nel processo di autorizzazione, da \cite{} }\label{fig:fedrampactors}
\end{figure}
...
\subsubsection{Virtualizzazione della rete}
...
\subsubsection {Determinazione dei confini e controlli di sicurezza relativi}
...
I controlli di sicurezza, organizzati sulla base del livello di sensibilità (basso e moderato), possono essere suddivisi nelle seguenti categorie:
\begin{table}[hbtp]
    \begin{tabulary}{\textwidth}{|L|L|L|L|L|}
    \hline
    \textbf{ID}  & \textbf{Famiglia}    &  \textbf{Classe}      & \textbf{Livello Basso}     & \textbf{Livello moderato}  \\    \hline
    AC  & Controllo degli accessi &               &                   &                   \\    \hline
    AT  & Awareness \& training  &               &                   &                   \\    \hline
    AU  & Audit and accountability  &               &                   &                   \\    \hline
    CA  & Certification, Accdeditation \& Security Assessment &               &                   &                   \\    \hline
...
\end{table}
\begin{itemize}
    \item[\textbf{AC}] Access Control, di tipo tecnico. 11 controlli di livello basso, 17 controlli di livello moderato
    \item[\textbf{AT}] Account Management, di4 controlli di livello basso, 4 controlli di livello moderato
    \item[\textbf{AU}] 
    \item[\textbf{CA}] 
    \item[\textbf{CM}] 
    \item[\textbf{CP}] 
