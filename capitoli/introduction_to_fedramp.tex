...
FedRAMP è il programma governativo americano l'applicazione del \textbf{FISMA} (Federal Information Security Management Act) nell'adozione di tecnologie cloud. % ELIA frase sconnessa
...
\begin{itemize}
    ...
    \item Offrendo un programma di analisi della conformità in grado di produrre % ELIA di produrre che???
    ...
    \item Un repository di pacchetti di autorizzazione per i servizi cloud che possono essere utilizzati dal governo % ELIA cosa possono essere utilizzati, i pacchetti o i servizi cloud??
\end{itemize}
