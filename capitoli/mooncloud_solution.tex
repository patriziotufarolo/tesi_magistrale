...
\begin{itemize}
    ...
    \item \textit{requirements.txt}, che, in Python, contiene tutte le librerie del database PyPI\foontnote{https://pypi.python.org/} da cui il codice del driver dipende.
\end{itemize}
...
\begin{js}
{
    ...
    "description":"It allows to execute a set of tests againt a given service to ensure that information are provided over a secure channel and stored over a secure storage.",
    "category":[],
    "formula":"c#1 and c#2",
